<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Chi tiết xuất xứ cho đối tác
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('admin') ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?= base_url('admin/partner_origin') ?>"><i class="fa fa-dashboard"></i> Danh sách xuất xứ cho đối tác</a></li>
            <li class="active">Chi tiết xuất xứ cho đối tác</li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="detail-info col-md-6">
                                ...
                                <a href="<?= base_url('admin/partner_origin/edit/' . $detail['id']) ?>" class="btn btn-warning" role="button">Chỉnh sửa</a>
                                <br>
                                <br>
                            </div>
                            <br>
