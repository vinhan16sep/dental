...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('admin/qna') ?>"><i class="fa fa-dashboard"></i> Danh sách Hỏi đáp</a></li>
            <li class="active">Cập nhật Hỏi đáp</li>
        </ol>
    </section>
                ...
                <div class="box box-default">
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_textarea('question', $detail['question'], 'class="form-control" id="question"');
                            ?>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_textarea('answer', $detail['answer'], 'class="form-control" id="answer"');
                            ?>
                        </div>
