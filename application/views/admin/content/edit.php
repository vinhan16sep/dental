<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Cập nhật nội dung tĩnh </li>
        </ol>
    </section>
                ...
                <div class="box box-default">
                    <div class="box-body">
                                ...
                                <select name="type" class="form-control" id="type" disabled>
                                    ...
                                    <?php if ( $types ): ?>
                                        <?php foreach ($types as $key => $value): ?>
                                            <option value="<?php echo $key ?>" <?php echo ($key == $detail['type'])? 'selected' : '' ?> ><?php echo $value ?></option>
                                        <?php endforeach ?>
                                    <?php endif ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_textarea('content', $detail['content'], 'class="form-control" id="content"');
                            ?>
                        </div>
