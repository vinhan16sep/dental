...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Chi tiết đối tác</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
                            ...
                            <div class="detail-image col-md-6">
                                ...
                                <div class="row">
                                    <div class="item col-md-12">
                                        <div class="mask-lg">
                                            <?php if ( $detail['image'] ): ?>
                                                <img src="<?= base_url('assets/upload/partner/' . $detail['slug'] . '/' . $detail['image'] ) ?>" alt="Image Detail" width=100%>    
                                            <?php endif ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-md-3">
                <div class="box box-warning">
                    <div class="box-body">
                        <a href="<?= base_url('admin/partner/edit/' . $detail['id']) ?>" class="btn btn-warning" role="button">Chỉnh sửa</a>
                    </div>
                </div>
            </div>
        </div>
